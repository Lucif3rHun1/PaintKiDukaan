...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings::list_locations,
            commands::settings::add_location,
            commands::settings::remove_location,
            commands::settings::list_customer_types,
            commands::settings::add_customer_type,
            commands::settings::remove_customer_type,
