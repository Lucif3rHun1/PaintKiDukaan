...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::customer_ledger::customer_outstanding,
            commands::customer_ledger::customer_ledger,
            commands::customer_ledger::create_customer_credit_invoice,
            commands::customer_ledger::customer_credit_sales,
            commands::customer_ledger::record_customer_payment,
            // Vendors (Slice B)
            ...
            // Vendor ledger (Slice B)
            commands::vendor_ledger::record_vendor_payment,
            commands::vendor_ledger::vendor_outstanding,
            commands::vendor_ledger::list_vendor_payments,
            // Sales (Slice C)
